class splunk::linux_server {
  ...
  file {"splunk_installer":
    path    => "${splunk::params::linux_stage_dir}/${splunk::params::splunk_package_name}",
    source  => "${splunk::params::source_root}/${splunk::params::splunk_package_name}",
  ...
  package {"splunk":
    ...
    source   => "${splunk::params::linux_stage_dir}/${splunk::params::splunk_package_name}",
